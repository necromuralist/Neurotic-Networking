...
#+END_COMMENT
#+PROPERTY: header-args :session ~/.local/share/jupyter/runtime/kernel-3e8f8fe8-14bb-4e0d-899a-8b2bd5bc122e-ssh.json
...
#+begin_src python :results none :exports none
from neurotic.nlp.machine_translation import input_encoder, pre_attention_decoder, prepare_attention_input
#+end_src
* Helper functions
** Input encoder
