...
#+begin_src python :results none :../../files/posts/nlp/visualizing-naive-bayes/ellipses.png
...
# seaborn.scatterplot(x="positive", y="negative",  ax=axis, data=features,
#                    hue="sentiment", facecolors="none")
