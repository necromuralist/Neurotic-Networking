...
This concludes the series begun at {{% undoc %}}01-twitter-preprocessing-with-nltk{{% /undoc %}}.


I should mention that I used {{% undoc %}}bib-speech-and-language-processing-jurafsky-martin{{% /undoc %}} to understanding the math.
