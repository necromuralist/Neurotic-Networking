...
#+RESULTS:
#+BEGIN_EXPORT html
<script src="line_counts.js" id="b7a6d97e-496a-48cc-a0c7-37fc171e343b"></script>
#+END_EXPORT
...
#+RESULTS:
#+BEGIN_EXPORT html
<script src="line_counts_boxplot.js" id="fb679b0b-929e-4c23-b984-d37588df5f9c"></script>
#+END_EXPORT
...
def train_test_split(words: WordIndices, sequence_length: int) -> tuple:
    ...
    Returns:
     list of training tensors, target tensors
    """
    training, testing = [], []
...
assert training[0] == [1, 2, 3, 4]
assert testing[0] == 5
assert training[1] == [2, 3, 4, 5]
assert testing[1] == 6
assert training[2] == [3, 4, 5, 6]
assert testing[2] == 7
