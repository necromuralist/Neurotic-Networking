...
#+END_COMMENT
#+PROPERTY: header-args :session ~/.local/share/jupyter/runtime/kernel-8921a2a5-9d7d-4207-9c30-bde0b41c8ea7-ssh.json
#+OPTIONS: ^:{}
#+OPTIONS: H:5
#+TOC: headlines 2
...
#+begin_src python :results none
def search_images(keywords: str,
                  max_images: int=200,
                  license_image: str="any") -> ListLike:
...
** A Test Of Rabbits & Pigs
We'll start by checking that our searcher is working using the keywords "rabbit" and "photos".

#+begin_src python :results output :exports both
URLS = search_images('rabbit', max_images=1, license_image="Public")
print(URLS[0])
#+end_src
...
#+begin_src python :results none
RABBIT_OUTPUT = "/tmp/rabbit.jpg"
download_url(URLS[0], RABBIT_OUTPUT, show_progress=False)
#+end_src
...
#+begin_src python :results output :exports both
PIG_OUTPUT = "/tmp/pig.jpg"
URL = search_images("pig photos",
                    max_images=1)[0]
print(URL)
download_url(URL,
             PIG_OUTPUT,
...
#+RESULTS:
: http://www.publicdomainpictures.net/pictures/170000/velka/smiling-pig-1463074462eDC.jpg
...
#+begin_src python :results output :exports both
KEYWORDS = ("rabbit", "pig")
DATA_PATH = Path("/tmp/rabbit-or-pig/")
PAUSE = 10
...
Started: 2022-11-12 16:40:38.130024
rabbit 
/home/athena/.conda/envs/neurotic-fastai/lib/python3.9/site-packages/PIL/Image.py:959: UserWarning: Palette images with Transparency expressed in bytes should be converted to RGBA images
  warnings.warn(
/home/athena/.conda/envs/neurotic-fastai/lib/python3.9/site-packages/PIL/Image.py:959: UserWarning: Palette images with Transparency expressed in bytes should be converted to RGBA images
  warnings.warn(
/home/athena/.conda/envs/neurotic-fastai/lib/python3.9/site-packages/PIL/Image.py:959: UserWarning: Palette images with Transparency expressed in bytes should be converted to RGBA images
...
/home/athena/.conda/envs/neurotic-fastai/lib/python3.9/site-packages/PIL/Image.py:959: UserWarning: Palette images with Transparency expressed in bytes should be converted to RGBA images
  warnings.warn(
Ended: 2022-11-12 16:44:02.356436
Elapsed: 0:03:24.226412
#+end_example
...
#+RESULTS:
: 10 images were deemed failures.
